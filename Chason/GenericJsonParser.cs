...
namespace Chason
{
    ...
    /// All numbers are parsed to doubles.
    /// </summary>
    internal class GenericJsonParser
    {
        enum Token
        {
        ...
        internal GenericJsonParser(string json)
        {
        ...
        private object ParseValue()
        {
            ...
            throw new SerializationException("Unrecognized token at index" + index);
        }
        ...
        private string ParseNumber()
        {
            ...
            do
            {
                ...
                {
                    if (++index == json.Length) throw new SerializationException("Unexpected end of string whilst parsing number");
                    continue;
                }
        ...
        private Token NextTokenCore()
        {
            ...
            throw new SerializationException("Could not find token at index " + --index);
        }
    }

    ////internal sealed class PropertyParserComparer : IComparer<PropertyParser>
    ////{
    ////    public static readonly PropertyParserComparer Instance = new PropertyParserComparer();
        
    ////    public int Compare(PropertyParser x, PropertyParser y)
    ////    {
